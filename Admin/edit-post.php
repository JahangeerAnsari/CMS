...
$_session_author_image = $_SESSION['author_image'];
  if(isset($_GET['edit'])){
      ...
      else if($_session_role == 'author'){
        $get_query = "SELECT * FROM posts WHERE id = $edit_id and author = '$_session_username'";
      $get_run = mysqli_query($con, $get_query);  
      }
   ...
   <div class="wrapper">
    ...
    <div class="container-fluid body-section">
        <div class="row">
            ...
            <div class="col-md-9">
                <h1> <i class="fa fa-plus-pencil"></i>Edit Posts <small>Edit Post Details</small></h1><hr>
                <ol class="breadcrumb">
                    <li ><a href="index.php"><i class="fa fa-tachometer"></i>Dashboard</a> </li>./
                    
                    <li class="active"> <i class="fa fa-pencil"></i>Edit Posts</li>
                 </ol>
