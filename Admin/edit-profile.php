   ...
   <div class="wrapper">
    ...
    <div class="container-fluid body-section">
        <div class="row">
            ...
            <div class="col-md-9">
                <h1> <i class="fa fa-users"></i>Edit Profile <small> Edit Profile Details </small></h1><hr>
                <ol class="breadcrumb">
                    <li ><a href=""> <i class="fa fa-tachometer"></i> Dashboard</a></li>/.
                    <li class="active"> <i class="fa fa-users"></i> Edit Profile</li>
                 </ol>
                   ...
                   if(isset($_POST['submit'])){
                      ...
                      $salt_query = "SELECT * FROM users ORDER BY id DESC LIMIT 1";
                       ...
                       if(empty($first_name) or empty($last_name) or empty($image)){
                          ...
                          $update_query = "UPDATE `users` SET `first_name` = '$first_name', `last_name` = '$last_name', `image` = '$image', `role` =  `details` = '$details'";
                          if(isset($password)){
