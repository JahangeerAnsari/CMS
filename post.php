           ...
           <div class="jumbotron">
                <div class="container">
                    <div id="details" class="animated fadeInLeft">
                        ...
                        <p>this is post page where you gona post  </p>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                          <!--post start from here-->
                                <div class="post">
                                  ...
                                  <a href="post.php?=post_id=<?php echo $id;?>"><h2><?php echo $title;?></h2></a>  
                                    ...
                                    <a href="#" style=" width: 90%;margin: 5px auto; background: red; display: block;" ><img src="img/<?php echo $image;?>" style=" height: 350px; margin: 0px auto" alt="Post Image"></a>
                                    <div class="desc">
                                        <?php echo $post_data; ?>
                          ...
                          <div class="author">
                            <div class="row">
                                <div class="col-sm-3">
                                    <img src="img/<?php echo $author_image;?>" alt="Profile Image" class="pic-circle-corner">
                                </div>
                                <div class="col-sm-9">
...
<!--                           <div class="comment">-->
                                  ...
                                  <hr>
                                   ...
                                   <div class="col-sm-2">
                                       <img src="img/<?php echo $c_image;?>" alt="Unknown Profile" class="pic-circle-corner">
                                   </div>
                                   <div class="col-sm-10">
                             ...
                             <?php } 
                                ...
                                if(isset($_POST['submit'])){
                                    ...
                                    if(empty($cs_name) or empty($cs_email) or empty($cs_comment)){
                                        $error_msg = "All (*) fiels is required";
                                        
                                    } 
                                    else {
                                        $cs_query = "INSERT INTO `comments` (`id`, `date`, `name`, `username`, `post_id`, `email`, `website`, `image`, `comment`, `status`) VALUES (NULL, '$cs_date', '$cs_website', 'user', '$post_id', '$cs_email', '$cs_website', 'profile1.png', '$cs_comment', 'pending');";
                                        if(mysqli_query($con,$cs_query)){
                                            $msg = "Comment has been waiting for approval";
                                   ...
                                   <div class="col-md-12">
                                      ...
                                      <div class="form-group">
                                        <label for="email">Email Addresss:</label>  
                                          <input type="email" id="email" value="<?php if(isset($cs_email)){echo $cs_email;}?>" name="email" class="form-control" placeholder="your email here">
                                      </div>
                                      <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        <label for="comment">Comment:</label>  
                                          <textarea type="text" id="comment" name="comment" cols="30" rows="10" class="form-control" placeholder="comment here.."><?php if(isset($cs_comment)){echo $cs_comment;}?></textarea>
                                      </div>
