...
if(isset($_GET['del'])){
    ...
    {
        $error = "Comment has not  been deleted try again..";
    }
    }        
...
if(isset($_GET['unapprove'])){
    ...
    {
        $error = "Comment has not  been Uapproved..";
    }
    }        
                         ...
                         if(isset($_POST['reply'])){
                             ...
                             if(empty($comment_data)){
                                ...
                                $first_name = $get_user_row['first_name'];
                                 ...
                                 $insert_comment_query = "INSERT INTO comments (date,name,post_id,email,image,comment,status) VALUES ('$date','$session_username','$reply_id','$email','$image','$comment_data','approve')";
                                 if(mysqli_query($con,$insert_comment_query)){
                                     $comment_msg = "comment has been submited";
                                 }
                                 else{
                                    $comment_error = "comment has not submited"; 
                                 }
                             }
                         }
